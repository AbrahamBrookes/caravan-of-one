...
var TerrainVertexScn = preload("res://Terrain/TTDstyle/TerrainVertex.tscn")
var TerrainSquareScn = preload("res://Terrain/TTDstyle/TerrainSquare.tscn")
...
func gen_mesh():
	...
	ResourceSaver.save(mesh, "res://Terrain/TTDstyle/terrain_mesh.tres", ResourceSaver.FLAG_COMPRESS)
