...
# the TownCenter is the center of any given town. It is a decorator because it consumes a single cube
# in the terrain. Players can click on the town marker to get info about the town. A TownCenter may
